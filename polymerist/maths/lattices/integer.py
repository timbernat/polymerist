...
class CubicIntegerLattice:
    ...
    def transformed_points(self, matrix : np.ndarray[Shape[N,N], float], periodic : bool=False) -> np.ndarray[Shape[M, N], float]:
    ...
    # TODO: add affine transformation (square matrix must be of dimension N + 1)
